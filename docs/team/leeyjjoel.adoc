...
* *Major enhancement*: I added the *rank* command as well as the scheduling algorithm behind it
** What it does: allows the users to sort cards by when they should be reviewed.
...
mode, using the *supermemo2* spaced recognition algorithm, the student is saved from the hassle of separating his/her flashcards
...
** Added system tests to increase robustness of the application
** Implemented the `editdeck` command that allows users to update the details of their deck.
** Added an exit command to allow the user to leave the deck
