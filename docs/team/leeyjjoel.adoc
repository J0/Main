...
This portfolio outlines my contributions  to the following project(s).
...
interacts with it using a Command Line Interface, and it has a GUI created with JavaFX. With the same spaced repetition learning methods used by the likes of Duolingo, Wani Kani, and Memrise.
we aim to revolutionize the studying experience of the tech savy user. On top of being an efficient tool,
Anakin is environmentally friendly, having zero paper wastage unlike conventional flashcards.
...
** Highlights: This allows user to focus on what's important for review by prioritizing
